...
const PantallaInicioSecretario = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['right', 'left', 'bottom']}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Panel de Secretario</Text>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.welcomeSection}>
          ...
          <Text style={styles.userName}>{usuario ? `${usuario.nombre} ${usuario.apellido}` : 'Secretario'}</Text>
          <Text style={styles.userRole}>Secretario del Sistema</Text>
        </View>
        ...
        <View style={styles.cardSection}>
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: colores.info }]}
        ...
        <View style={styles.cardSection}>
          ...
          <View style={styles.infoCard}>
            <Text style={styles.infoTitle}>Funcionalidades del Secretario</Text>
            <Text style={styles.infoContent}>
              Como secretario del sistema, tiene acceso a las siguientes funcionalidades:
            </Text>
...
export default PantallaInicioSecretario;
